...
Use the /lisa:intake skill to scan the queue for Ready items and dispatch each one through the appropriate single-item lifecycle skill. Use the user's surrounding request as this command's arguments.

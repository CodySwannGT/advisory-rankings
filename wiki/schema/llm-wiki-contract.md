# Advisory Rankings Operational Brain — LLM Wiki Contract

> Generated by the `lisa-wiki` plugin from `wiki/lisa-wiki.config.json`.
> kernelVersion: 2.25.2 · schemaVersion: 1.0.0 · rendered: 2026-05-23
...
## What this is
A git-native markdown knowledge base under `wiki/`, owned by **CodySwannGT/advisory-rankings**, maintained by the

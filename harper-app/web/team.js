...
import { parseRoute, firmPath, advisorPath } from './router.js';
import {
	...
	right.appendChild(DetailsCard({
		...
		pairs: [
			...
			['Current firm',  d.currentFirm
				? el('a', { href: firmPath(d.currentFirm) }, d.currentFirm.name)
				: null],
		],
	}));

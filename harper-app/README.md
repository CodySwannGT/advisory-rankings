...
- **Custom resources** at `http://127.0.0.1:9926/Feed`,
  ...
  `missingField`, and `limit`; `/research/freshness` exposes the same
  filter set in the public web UI.

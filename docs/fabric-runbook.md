...
fabric-deploy branch layout (commit a03f495):
  ...
  firms/ / advisors/ / teams/ / articles/ / recruiting/ / rankings/ / regulatory/ / favicon/ + seo_shell.js
...
> `teams.html`), `recruiting.html`, `rankings.html`, `regulatory.html`, and `login.html`.
> Clean routes (`/firms`, `/advisors`, `/teams`, `/recruiting`, `/rankings`, `/regulatory`,

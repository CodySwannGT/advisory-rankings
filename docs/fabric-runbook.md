...
fabric-deploy branch layout (commit a03f495):
  ...
  firms/ / advisors/ / teams/ / articles/ / recruiting/ / rankings/ + seo_shell.js
...
> `teams.html`), `recruiting.html`, `rankings.html`, and `login.html`.
> Clean routes (`/firms`, `/advisors`, `/teams`, `/recruiting`, `/rankings`,

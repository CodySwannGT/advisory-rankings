...
fabric-deploy branch layout (commit a03f495):
  ...
  branches/ / firms/ / advisors/ / teams/ / articles/ / data-coverage/ / recruiting/ / recruiting-shortlist/ / rankings/ / regulatory/ / regulatory-discrepancies/ / corrections/ / compare/ / report-packet/ / watchlists/ / login/ / favicon/ + seo_shell.js
...
> `teams.html`), `coverage.html`, `recruiting.html`,
> `recruiting-shortlist.html`, `rankings.html`, `regulatory.html`,
> `compare.html`, `correction-inbox.html`, and
> `report-packet.html`.
> Clean routes (`/firms`, `/advisors`, `/teams`, `/coverage`, `/recruiting`,
> `/recruiting/shortlist`, `/rankings`, `/regulatory`, `/compare`,
